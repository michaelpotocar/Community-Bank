...
|-------------------------------------------------------------------|---                       |---            |--------------------------------------------------------|
| Team name                                                         |Sprint 1 Module 1         |               | name: Ptoject Kitty                                    |
| [Design Document - problem statement](example_design_document.md) |Sprint 1 Module 2         |               |                                                        |
| [Team Charter](team_charter.md)                                   |Sprint 1 Module 3         |               |                                                        |
| [Design Document](example_design_document.md)                             |Sprint 1 REQUIRED TO GO ON|               |                                                        |
